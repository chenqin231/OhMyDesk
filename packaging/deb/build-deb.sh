...
# OhMyDesk 客户端配置 —— 安装后按内网服务端地址修改本文件。
# 中转服务端 WS 地址（默认本机；改为 ws://<服务端IP>:8765/ws）
OHMYDESK_SERVER=ws://127.0.0.1:8765/ws
...
echo "① 编辑 /etc/ohmydesk/client.env 设置 OHMYDESK_SERVER=ws://<服务端IP>:8765/ws"
